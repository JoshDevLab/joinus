package com.josh.joinus.core.security.token;

import com.josh.joinus.core.security.exception.TokenValidFailedException;
...
public class AuthTokenProvider {
    ...
    public AuthTokenProvider(String secret, UserDetailsService customUserDetailsService) {
